...
Pick ONE of the three options below, then run the notebook.

### Option A: Conda (recommended - handles RDKit automatically)

```bash
# 1. Clone the repository
git clone https://github.com/ofirsimhi/logP_factor_learning.git
cd logP_factor_learning

# 2. Create the conda environment (this installs everything including RDKit)
...
### Option B: pip with virtual environment (venv)
...
# 4. Upgrade pip (avoids common install issues)
...
### Option C: pip install directly (no virtual environment)
...
> **That's it.** The notebook downloads the dataset automatically on first run.
...
### DATA FILES
--------------
Source: OPERA dataset (Mansouri et al., 2018), hosted by DeepChem as part of the
        MoleculeNet benchmark (Wu et al., 2018).
URL: https://deepchemdata.s3-us-west-1.amazonaws.com/datasets/Lipophilicity.csv

References:
  - Mansouri et al., "OPERA models for predicting physicochemical properties
    and environmental fate endpoints", J. Cheminformatics, 2018.
